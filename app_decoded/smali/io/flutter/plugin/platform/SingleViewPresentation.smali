...
.field private rootView:Lio/flutter/plugin/platform/k;

.field private startFocused:Z

.field private final state:Lio/flutter/plugin/platform/n;

.field private viewId:I


# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/view/Display;Lio/flutter/plugin/platform/a;Lio/flutter/plugin/platform/n;Landroid/view/View$OnFocusChangeListener;Z)V
    .locals 2
    ...
    .line 16
    invoke-direct {v0, p1, v1}, Lio/flutter/plugin/platform/l;-><init>(Landroid/content/Context;Landroid/view/inputmethod/InputMethodManager;)V
    ...
    .line 20
    iput-object p4, p0, Lio/flutter/plugin/platform/SingleViewPresentation;->state:Lio/flutter/plugin/platform/n;
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/Display;Lio/flutter/plugin/platform/d;Lio/flutter/plugin/platform/a;ILandroid/view/View$OnFocusChangeListener;)V
    ...
    .line 1
    new-instance p3, Lio/flutter/plugin/platform/l;

    const/4 v0, 0x0

    .line 2
    invoke-direct {p3, p1, v0}, Lio/flutter/plugin/platform/l;-><init>(Landroid/content/Context;Landroid/view/inputmethod/InputMethodManager;)V
    ...
    .line 11
    iput-object p1, p0, Lio/flutter/plugin/platform/SingleViewPresentation;->state:Lio/flutter/plugin/platform/n;
...
# virtual methods
.method public detachState()Lio/flutter/plugin/platform/n;
    .locals 1
    ...
    .line 8
    :cond_0
    iget-object v0, p0, Lio/flutter/plugin/platform/SingleViewPresentation;->state:Lio/flutter/plugin/platform/n;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 16
    .line 17
    iget-object p1, p0, Lio/flutter/plugin/platform/SingleViewPresentation;->state:Lio/flutter/plugin/platform/n;

    .line 18
    .line 19
    iget-object v0, p1, Lio/flutter/plugin/platform/n;->b:Lio/flutter/plugin/platform/j;
    ...
    .line 29
    invoke-direct {v0, v1}, Lio/flutter/plugin/platform/j;-><init>(Landroid/content/Context;)V

    .line 30
    .line 31
    .line 32
    iput-object v0, p1, Lio/flutter/plugin/platform/n;->b:Lio/flutter/plugin/platform/j;
    ...
    .line 35
    .line 36
    iget-object p1, p1, Lio/flutter/plugin/platform/n;->a:Lio/flutter/plugin/platform/p;
    ...
    .line 55
    .line 56
    iget-object v2, v0, Lio/flutter/plugin/platform/n;->b:Lio/flutter/plugin/platform/j;

    .line 57
    .line 58
    invoke-direct {v1, p1, v2}, Lio/flutter/plugin/platform/p;-><init>(Landroid/view/WindowManager;Lio/flutter/plugin/platform/j;)V

    .line 59
    .line 60
    .line 61
    iput-object v1, v0, Lio/flutter/plugin/platform/n;->a:Lio/flutter/plugin/platform/p;
    ...
    .line 73
    .line 74
    new-instance p1, Lio/flutter/plugin/platform/m;
    ...
    .line 80
    iget-object v1, p0, Lio/flutter/plugin/platform/SingleViewPresentation;->state:Lio/flutter/plugin/platform/n;

    .line 81
    .line 82
    iget-object v1, v1, Lio/flutter/plugin/platform/n;->a:Lio/flutter/plugin/platform/p;
    ...
    .line 85
    .line 86
    invoke-direct {p1, v0, v1, v2}, Lio/flutter/plugin/platform/m;-><init>(Landroid/content/Context;Lio/flutter/plugin/platform/p;Landroid/content/Context;)V
